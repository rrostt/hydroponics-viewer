...
const NoImagesYet = ({ streamId }) =>
  <div style={{ margin: 40 }}>
    ...
    <p><b>Upload an image:</b> You can upload an image directly in your browser by clicking <Link href={`/streams/upload?id=${streamId}`}>here</Link>. <em>(Available soon)</em></p>
